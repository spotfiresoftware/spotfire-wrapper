...
export * from './lib/editor/spotfire-editor.component';
...
export { SpotfireParameters, SpotfireReporting, SpotfireFiltering, SpotfireServer } from './lib/spotfire-webplayer';
